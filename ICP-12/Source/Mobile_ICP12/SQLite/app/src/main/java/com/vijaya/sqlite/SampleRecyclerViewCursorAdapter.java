...
public class SampleRecyclerViewCursorAdapter extends RecyclerView.Adapter<SampleRecyclerViewCursorAdapter.ViewHolder> {
    ...
    public SampleRecyclerViewCursorAdapter(Context context, Cursor cursor, AdaptorListener listener) {
    ...
    public static AdaptorListener onClickListener;
        ...
        public void bindCursor(final Cursor cursor) {
            ...
            itemBinding.deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onClickListener.deleteButtonOnClick(view, cursor.getString(cursor.getColumnIndexOrThrow(
