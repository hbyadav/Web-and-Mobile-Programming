...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handing Logout button event here

        btnLogout.setOnClickListener(new View.OnClickListener() {       // button listener
            @Override
            public void onClick(View view) {
                mFirebaseAuth = FirebaseAuth.getInstance();
                mFirebaseAuth.signOut();                                // sign out from Firebase
                Intent toLogin = new Intent(HomeActivity.this, LoginActivity.class);
                startActivity(toLogin);                                 // redirect to login page
            }
        });
    }
